...
<P>This appendix contains sample versions of the four programs described
in the book. These are the adventure game (Nani Search), the intelligent
genealogical logicbase (Family), the customer order entry system (Custord),
and the expert system (Birds). </P>

<h3><a href="#Nanisearch">Nani Search</a><br />
  <a href="#Family">Family</a><br />
  <a href="#Custord">Custord</a><br />
  <a href="#Birds">Birds</a></h3>


<H3><A NAME="NaniSearch"></A>Nani Search </H3>

<PRE><FONT COLOR=navy>% NANI SEARCH - A sample adventure game
...
<H3><A NAME="Family"></A>Family</H3>

<PRE><FONT COLOR=navy>% GENE.PRO - genealogical relationships
%
...
<H3><A NAME="Custord"></A>Custord</H3>

<PRE><FONT COLOR=navy>% CUSTORD 
